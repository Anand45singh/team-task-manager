...
const styles = `
  ...
  .auth-bg-orb1 {
    ...
    width: 520px;
    height: 520px;
    background: radial-gradient(circle, rgba(0,160,255,0.14) 0%, transparent 65%);
    pointer-events: none;
  }
  ...
  .auth-bg-orb2 {
    ...
    width: 480px;
    height: 480px;
    background: radial-gradient(circle, rgba(56,100,255,0.16) 0%, transparent 65%);
    pointer-events: none;
  }
  ...
  .step-dot.active {
    background: linear-gradient(90deg, #1a56e8, #3b9eff);
  }
    ...
    <>
      ...
      <div className="auth-root">
        ...
        <div className="auth-card">
          ...
          <p className="auth-welcome">Create your account to get started</p>
